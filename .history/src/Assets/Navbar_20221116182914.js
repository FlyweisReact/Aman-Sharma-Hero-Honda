        ...
        <div className="upBar" id="upBar" style={{ top: "100px" }}>
          ...
          <div className="sidebar">
            <div className="sideDiv">
              <img src="https://media.istockphoto.com/id/1208768030/vector/coupon-frame-clip-to-save-frame-with-a-dotted-bounding.jpg?s=612x612&w=0&k=20&c=avlbnoR3muVcmRJ3Plg7yexP-1FC1ZbTHS_mDakHGT0=" />{" "}
